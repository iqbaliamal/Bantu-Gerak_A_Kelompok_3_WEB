                        ...
                        <form action="{{route('admin.donation.filter') }}" method="GET">
                            <div class="form-row align-items-center">
                              <div class="col-lg-5 col-sm-auto">
                                ...
                                <input type="date" class="form-control mb-2" name="date_from"  value="{{ old('date_form') ?? request()->query('date_from') }}">
                              </div>
                              <div class="col-lg-5 col-sm-auto">
                                <label for="inlineFormInput">Tanggal Ahir</label>
                                <input type="date" class="form-control mb-2" name="date_to" value="{{ old('date_to') ?? request()->query('date_to') }}">
                              </div>
