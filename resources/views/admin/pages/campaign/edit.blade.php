                            ...
                            <form action="{{route('admin.campaign.update', $campaign->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('target_donation') is-invalid @enderror" name="target_donation"
                                            value="{{ old('target_donation', $campaign->target_donation) }}" placeholder="Target Donasi, Ex: 10000000" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('max_date') is-invalid @enderror" name="max_date"
                                            value="{{ old('max_date', $campaign->max_date) }}" required>
                                    </div>
                                    @error('max_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" required>{{ old('description', $campaign->description) }}</textarea>
                                    </div>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="modal-footer">
                                    <a href="{{route('admin.campaign.index')}}" type="button" class="btn btn-secondary">Batal</a>
