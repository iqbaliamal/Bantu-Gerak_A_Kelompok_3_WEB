        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ request()->is('admin/category') ? 'active' : '' }}">
                <a href="{{route('admin.category.index')}}" class="nav-link"><i
                        class="fas fa-folder"></i><span>Kategori</span></a>
            </li>
            <li class="{{ request()->is('admin/campaign') ? 'active' : '' }}">
                <a href="{{route('admin.campaign.index')}}" class="nav-link"><i
                        class="fas fa-flag"></i><span>Campaigns</span></a>
            </li>
            ...
            <li class="{{ request()->is('admin/donatur') ? 'active' : '' }}">
                <a href="{{route('admin.donatur.index')}}" class="nav-link"><i
                        class="fas fa-users"></i><span>Donatur</span></a>
            </li>
            <li class="{{ request()->is('admin/donation') ? 'active' : '' }}">
                <a href="{{route('admin.donation.index')}}" class="nav-link"><i
                        class="fas fa-chart-line"></i><span>Donations</span></a>
            </li>
            <li class="{{ request()->is('admin/program') ? 'active' : '' }}">
                <a href="{{route('admin.program.index')}}" class="nav-link"><i class="fas fa-bookmark"></i><span>Program
                        Kebaikan</span></a>
            </li>
            ...
            <li class="{{ request()->is('admin/publication') ? 'active' : '' }}">
                <a href="{{route('admin.publication.index')}}" class="nav-link"><i
                        class="fas fa-newspaper"></i><span>Publication</span></a>
            </li>

            <li class="menu-header">Profil</li>
            <li class="{{ request()->is('admin/profil') ? 'active' : '' }}">
                <a href="{{route('admin.profile.index', ['id' =>  Auth::user()->id])}}" class="nav-link"><i
                        class="fas fa-user-circle"></i><span>Profil Saya</span></a>
            </li>
